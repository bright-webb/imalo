...
@Component({
  selector: 'app-underveloped',
  templateUrl: './underveloped.component.html',
  styleUrls: ['./underveloped.component.scss']
})


export class UndervelopedComponent {
...
propertyCards = [
  ...
  ngOnInit(){
    this.titleService.setTitle("Imalo | Underveloped Properties");
    this.pageTitleService.setPageTitle("Underveloper Properties");
